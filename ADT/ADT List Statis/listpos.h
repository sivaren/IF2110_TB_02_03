...
typedef int ElTypeListStat;  /* type elemen List */
typedef struct {
   ElTypeListStat contents[CAPACITY_LISTSTAT]; /* memori tempat penyimpan elemen (container) */
} ListStatPos;
...
/* ********** SELEKTOR ********** */
#define ELMTListStat(l, i) (l).contents[(i)]
